...
def main() -> None:
    st.set_page_config(page_title="SuppBro HW7", layout="wide")
    init_state()

    st.title("SuppBro HW7 LangGraph workflow")
    st.caption("Chat + trace dashboard for the framework-based HW6 workflow.")
